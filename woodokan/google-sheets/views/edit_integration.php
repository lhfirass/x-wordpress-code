...
$form_providers_html = woodokan_get_form_providers_html();
?>
...
?>" method="post" id="edit-integration" >
                ...
                <input type="hidden" name="action" value="woodokan_save_integration">
...
<?php 
do_action( 'woodokan_action_fields' );
?>
...
?></option>
            ...
            <select v-model="condition.operator">
                <?php 
$operators = woodokan_get_cl_conditions();
