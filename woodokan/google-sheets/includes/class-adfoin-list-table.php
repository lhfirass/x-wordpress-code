...
class woodokan_google_sheets_integration_List_Table extends WP_List_Table {
    ...
    function column_default( $item, $column_name ) {
        ...
        return apply_filters( 'woodokan_integration_table_column_value', $value, $item, $column_name );
    }
    ...
    function get_columns() {
        ...
        return apply_filters( 'woodokan_integration_table_columns', $columns );
    }
    ...
    public function column_title( $item ) {
        ...
        $row_actions['delete'] = sprintf(
            ...
            wp_nonce_url(
                ...
                'woodokan_delete_integration_nonce'
            ),
        ...
        return $name . $this->row_actions( apply_filters( 'woodokan_integration_row_actions', $row_actions, $item ) );
    }
    ...
    public function column_action_provider( $item ) {
        $actions = woodokan_get_action_porviders();
 ...
 */
    public function column_task( $item ) {
        $tasks = woodokan_get_action_tasks( $item["action_provider"] );
    ...
    public function process_bulk_actions() {
        ...
        if ( 'delete' === $this->current_action() ) {
            ...
            if (
                ...
                wp_verify_nonce( $_REQUEST['_wpnonce'], 'woodokan_delete_integration_nonce' )
            ) {
    ...
    public function fetch_table_data( $args = array() ) {
        ...
        $log_table     = $wpdb->prefix . 'woodokan_integration';
    ...
    public function delete( $id='' ) {
        global $wpdb;
        $relation_table = $wpdb->prefix.'woodokan_integration';
