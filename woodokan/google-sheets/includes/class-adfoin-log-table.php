...
class woodokan_google_sheets_integration_Log_Table extends WP_List_Table {
    ...
    function __construct() {
        ...
        $this->log = new woodokan_google_sheets_integration_Log();
    }
    ...
    function column_default( $item, $column_name ) {
        ...
        return apply_filters( 'woodokan_log_table_column_value', $value, $item, $column_name );
    }
    ...
    function get_columns() {
        ...
        return apply_filters( 'woodokan_log_table_columns', $columns );
    }
    ...
    public function process_bulk_actions() {
        ...
        if ( 'delete' === $this->current_action() ) {
            ...
            if (
                ...
                wp_verify_nonce( $_REQUEST['_wpnonce'], 'woodokan_delete_log_nonce' )
            ) {
