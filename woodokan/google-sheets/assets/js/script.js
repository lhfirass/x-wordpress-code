...
Vue.component('mailchimp', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_mailchimp_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('sendfox', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_sendfox_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('livestorm', {
    ...
    methods: {
        getSessions: function() {
            ...
            var sessionRequestData = {
                'action': 'woodokan_get_livestorm_sessions',
    ...
    mounted: function() {
        ...
        var eventRequestData = {
            'action': 'woodokan_get_livestorm_events',
            '_nonce': adfoin.nonce
        };
...
Vue.component('demio', {
    ...
    methods: {
        getSessions: function() {
            ...
            var sessionRequestData = {
                'action': 'woodokan_get_demio_sessions',
                'eventId': this.fielddata.eventId,
                '_nonce': adfoin.nonce
            };
    ...
    mounted: function() {
        ...
        var eventRequestData = {
            'action': 'woodokan_get_demio_events',
            '_nonce': adfoin.nonce
        };
...
Vue.component('aweber', {
    ...
    methods: {
        getLists: function() {
            ...
            var listData = {
                'action': 'woodokan_get_aweber_lists',
                '_nonce': adfoin.nonce,
    ...
    mounted: function() {
        ...
        var accountRequestData = {
            'action': 'woodokan_get_aweber_accounts',
            '_nonce': adfoin.nonce
        };
...
Vue.component('activecampaign', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_activecampaign_list',
            '_nonce': adfoin.nonce
        };
        ...
        var automationRequestData = {
            'action': 'woodokan_get_activecampaign_automations',
            '_nonce': adfoin.nonce
        };
        ...
        var accountRequestData = {
            'action': 'woodokan_get_activecampaign_accounts',
            '_nonce': adfoin.nonce
        };
        ...
        var dealRequestData = {
            'action': 'woodokan_get_activecampaign_deal_fields',
            '_nonce': adfoin.nonce
        };
...
Vue.component('agilecrm', {
    ...
    mounted: function() {
        ...
        var pipelineRequestData = {
            'action': 'woodokan_get_agilecrm_pipelines',
            '_nonce': adfoin.nonce
        };
...
Vue.component('keap', {
    ...
    mounted: function() {
        ...
        // var pipelineRequestData = {
        //     'action': 'woodokan_get_keap_pipelines',
        //     '_nonce': adfoin.nonce
        // };
...
Vue.component('twilio', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_twilio_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('elasticemail', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_elasticemail_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('pabbly', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_pabbly_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('robly', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_robly_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('selzy', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_selzy_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('mailerlite', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_mailerlite_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('emailoctopus', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_emailoctopus_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('klaviyo', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_klaviyo_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('zohocampaigns', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_zohocampaigns_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('kartra', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_kartra_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('moosend', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_moosend_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('mailercloud', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_mailercloud_list',
            '_nonce': adfoin.nonce
        };
        ...
        var fieldRequestData = {
            'action': 'woodokan_get_mailercloud_contact_fields',
            '_nonce': adfoin.nonce
        };
...
Vue.component('convertkit', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_convertkit_list',
            '_nonce': adfoin.nonce
        };
        ...
        var formsRequestData = {
            'action': 'woodokan_get_convertkit_forms',
            '_nonce': adfoin.nonce
        };
...
Vue.component('wealthbox', {
    ...
    mounted: function() {
        ...
        var ownerRequestData = {
            'action': 'woodokan_get_wealthbox_owner_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('autopilot', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_autopilot_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('benchmark', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_benchmark_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('sendpulse', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_sendpulse_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('getresponse', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_getresponse_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('engagebay', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_engagebay_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('easysendy', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_easysendy_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('salesrocks', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_salesrocks_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('mailwizz', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_mailwizz_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('trello', {
    ...
    methods: {
        getLists: function() {
            ...
            var listData = {
                'action': 'woodokan_get_trello_lists',
                '_nonce': adfoin.nonce,
    ...
    mounted: function() {
        ...
        var boardRequestData = {
            'action': 'woodokan_get_trello_boards',
            '_nonce': adfoin.nonce
        };
...
Vue.component('mailjet', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_mailjet_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('mailify', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_mailify_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('lemlist', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_lemlist_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('directiq', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_directiq_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('sendinblue', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_sendinblue_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('drip', {
    ...
    methods: {
        getList: function() {
            ...
            jQuery.post( ajaxurl, listData, function( response ) {
                ...
                var workflowData = {
                    'action': 'woodokan_get_drip_workflows',
                    '_nonce': adfoin.nonce,
    ...
    mounted: function() {
        ...
        var accountRequestData = {
            'action': 'woodokan_get_drip_accounts',
            '_nonce': adfoin.nonce
        };
...
Vue.component('asana', {
    ...
    methods: {
        getProjects: function() {
            ...
            var projectData = {
                'action': 'woodokan_get_asana_projects',
                '_nonce': adfoin.nonce,
            ...
            var userData = {
                'action': 'woodokan_get_asana_users',
                '_nonce': adfoin.nonce,
                'workspaceId': this.fielddata.workspaceId
            };
        ...
        getSections: function() {
            ...
            var sectionData = {
                'action': 'woodokan_get_asana_sections',
                '_nonce': adfoin.nonce,
    ...
    mounted: function() {
        ...
        var workspaceRequestData = {
            'action': 'woodokan_get_asana_workspaces',
            '_nonce': adfoin.nonce
        };
...
Vue.component('clickup', {
    ...
    methods: {
        getSpaces: function() {
            ...
            var spaceData = {
                'action': 'woodokan_get_clickup_spaces',
                '_nonce': adfoin.nonce,
                'workspaceId': this.fielddata.workspaceId
            };
        ...
        getFolders: function() {
            ...
            var folderData = {
                'action': 'woodokan_get_clickup_folders',
                '_nonce': adfoin.nonce,
        ...
        getLists: function() {
            ...
            var listData = {
                'action': 'woodokan_get_clickup_lists',
                '_nonce': adfoin.nonce,
                'spaceId': this.fielddata.spaceId,
    ...
    mounted: function() {
        ...
        var workspaceRequestData = {
            'action': 'woodokan_get_clickup_workspaces',
            '_nonce': adfoin.nonce
        };
...
Vue.component('everwebinar', {
    ...
    methods: {
        getSchedule: function() {
            ...
            var scheduleData = {
                'action': 'woodokan_get_everwebinar_schedules',
                '_nonce': adfoin.nonce,
    ...
    mounted: function() {
        ...
        var webinarRequestData = {
            'action': 'woodokan_get_everwebinar_webinars',
            '_nonce': adfoin.nonce
        };
...
Vue.component('webinarjam', {
    ...
    methods: {
        getSchedule: function() {
            ...
            var scheduleData = {
                'action': 'woodokan_get_webinarjam_schedules',
                '_nonce': adfoin.nonce,
                'webinarId': this.fielddata.webinarId,
                'task': this.action.task
            };
    ...
    mounted: function() {
        ...
        var webinarRequestData = {
            'action': 'woodokan_get_webinarjam_webinars',
            '_nonce': adfoin.nonce
        };
        jQuery.post( ajaxurl, webinarRequestData, function( response ) {
            that.fielddata.webinars = response.data;
...
Vue.component('constantcontact', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_constantcontact_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('verticalresponse', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_verticalresponse_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('zohocrm', {
    ...
    methods: {
        getFields: function() {
            ...
            var fieldsRequestData = {
                'action': 'woodokan_get_zohocrm_module_fields',
                '_nonce': adfoin.nonce,
    ...
    mounted: function() {
        ...
        var userRequestData = {
            'action': 'woodokan_get_zohocrm_users',
            '_nonce': adfoin.nonce
        };
        ...
        var moduleRequestData = {
            'action': 'woodokan_get_zohocrm_modules',
            '_nonce': adfoin.nonce
        };
...
Vue.component('wordpress', {
    ...
    mounted: function() {
        ...
        var postTypeRequestData = {
            'action': 'woodokan_get_wordpress_post_types',
            '_nonce': adfoin.nonce
        };
...
Vue.component('googlecalendar', {
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_googlecalendar_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('googlesheets', {
    ...
    methods: {
        getWorksheets: function() {
            ...
            var listData = {
                'action': 'woodokan_googlesheets_get_worksheets',
                '_nonce': adfoin.nonce,
        ...
        getHeaders: function() {
            if(this.fielddata.worksheetId == 0 || this.fielddata.worksheetId) {
                ...
                var requestData = {
                    'action': 'woodokan_googlesheets_get_headers',
                    '_nonce': adfoin.nonce,
                    'spreadsheetId': this.fielddata.spreadsheetId,
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_spreadsheet_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('smartsheet', {
    ...
    methods: {
        getFields: function() {
            ...
            var listData = {
                'action': 'woodokan_get_smartsheet_fields',
                '_nonce': adfoin.nonce,
    ...
    mounted: function() {
        ...
        var listRequestData = {
            'action': 'woodokan_get_smartsheet_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('airtable', {
    ...
    methods: {
        getTables: function() {
            ...
            var tableData = {
                'action': 'woodokan_get_airtable_tables',
                '_nonce': adfoin.nonce,
        ...
        getFields: function() {
            ...
            var fieldData = {
                'action': 'woodokan_get_airtable_fields',
                '_nonce': adfoin.nonce,
                'baseId': this.fielddata.baseId,
    ...
    mounted: function() {
        ...
        var baseRequestData = {
            'action': 'woodokan_get_airable_bases',
            '_nonce': adfoin.nonce
        };
...
Vue.component('zohosheet', {
    ...
    methods: {
        getWorksheets: function() {
            ...
            var worksheetData = {
                'action': 'woodokan_get_zohosheet_worksheets',
                '_nonce': adfoin.nonce,
        ...
        getFields: function() {
            ...
            var fieldData = {
                'action': 'woodokan_get_zohosheet_fields',
                '_nonce': adfoin.nonce,
                'workbookId': this.fielddata.workbookId,
    ...
    mounted: function() {
        ...
        var workbookRequestData = {
            'action': 'woodokan_get_zohosheet_workbooks',
            '_nonce': adfoin.nonce
        };
...
Vue.component('pipedrive', {
    ...
    mounted: function() {
        ...
        var ownerRequestData = {
            'action': 'woodokan_get_pipedrive_owner_list',
            '_nonce': adfoin.nonce
        };
        ...
        var orgRequestData = {
            'action': 'woodokan_get_pipedrive_org_fields',
            '_nonce': adfoin.nonce
        };
        ...
        var personRequestData = {
            'action': 'woodokan_get_pipedrive_person_fields',
            '_nonce': adfoin.nonce
        };
        ...
        var dealRequestData = {
            'action': 'woodokan_get_pipedrive_deal_fields',
            '_nonce': adfoin.nonce
        };
...
Vue.component('capsulecrm', {
    ...
    methods: {
        getFields: function() {
            ...
            var allFieldsRequestData = {
                'action': 'woodokan_get_capsulecrm_all_fields',
                '_nonce': adfoin.nonce,
    ...
    mounted: function() {
        ...
        var ownerRequestData = {
            'action': 'woodokan_get_capsulecrm_owner_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('flowlu', {
    ...
    methods: {
        getFields: function() {
            ...
            var allFieldsRequestData = {
                'action': 'woodokan_get_flowlu_all_fields',
                '_nonce': adfoin.nonce,
                'selectedObjects': selectedObjects,
                'task': this.action.task
            };
    ...
    mounted: function() {
        ...
        var ownerRequestData = {
            'action': 'woodokan_get_flowlu_owner_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('salesflare', {
    ...
    methods: {
        getFields: function() {
            ...
            var allFieldsRequestData = {
                'action': 'woodokan_get_salesflare_all_fields',
                '_nonce': adfoin.nonce,
                'selectedObjects': selectedObjects,
                'task': this.action.task
            };
    ...
    mounted: function() {
        ...
        var ownerRequestData = {
            'action': 'woodokan_get_salesflare_owner_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('vtiger', {
    ...
    methods: {
        getFields: function() {
            ...
            var allFieldsRequestData = {
                'action': 'woodokan_get_vtiger_all_fields',
                '_nonce': adfoin.nonce,
                'selectedObjects': selectedObjects,
                'task': this.action.task
            };
    ...
    mounted: function() {
        ...
        var ownerRequestData = {
            'action': 'woodokan_get_vtiger_owner_list',
            '_nonce': adfoin.nonce
        };
...
Vue.component('hubspot', {
    ...
    mounted: function() {
        ...
        var contactRequestData = {
            'action': 'woodokan_get_hubspot_contact_fields',
            '_nonce': adfoin.nonce
        };
...
Vue.component('close', {
    ...
    mounted: function() {
        ...
        var allRequestData = {
            'action': 'woodokan_get_close_all_fields',
            '_nonce': adfoin.nonce
        };
...
Vue.component('insightly', {
    ...
    mounted: function() {
        ...
        var ownerRequestData = {
            'action': 'woodokan_get_insightly_owner_list',
            '_nonce': adfoin.nonce
        };
        ...
        var allRequestData = {
            'action': 'woodokan_get_insightly_all_fields',
            '_nonce': adfoin.nonce
        };
...
Vue.component('copper', {
    ...
    mounted: function() {
        ...
        var ownerRequestData = {
            'action': 'woodokan_get_copper_owner_list',
            '_nonce': adfoin.nonce
        };
        ...
        var allRequestData = {
            'action': 'woodokan_get_copper_all_fields',
            '_nonce': adfoin.nonce
        };
...
Vue.component('freshsales', {
    ...
    mounted: function() {
        ...
        var accountRequestData = {
            'action': 'woodokan_get_freshsales_account_fields',
            '_nonce': adfoin.nonce
        };
        ...
        var contactRequestData = {
            'action': 'woodokan_get_freshsales_contact_fields',
            '_nonce': adfoin.nonce
        };
        ...
        var dealRequestData = {
            'action': 'woodokan_get_freshsales_deal_fields',
            '_nonce': adfoin.nonce
        };
...
Vue.component('campaignmonitor', {
    ...
    methods: {
        getList: function() {
            ...
            var listData = {
                'action': 'woodokan_get_campaignmonitor_list',
                '_nonce': adfoin.nonce,
                'accountId': this.fielddata.accountId,
                'task': this.action.task
            };
    ...
    mounted: function() {
        ...
        var accountRequestData = {
            'action': 'woodokan_get_campaignmonitor_accounts',
            '_nonce': adfoin.nonce
        };
...
Vue.component('clinchpad', {
    ...
    methods: {
        getStage: function() {
            ...
            var stageData = {
                'action': 'woodokan_get_clinchpad_stage',
                '_nonce': adfoin.nonce,
    ...
    mounted: function() {
        ...
        var userRequestData = {
            'action': 'woodokan_get_clinchpad_user',
            '_nonce': adfoin.nonce
        };
        ...
        var pipelineRequestData = {
            'action': 'woodokan_get_clinchpad_pipeline',
            '_nonce': adfoin.nonce
        };
...
var adfoinNewIntegration = new Vue({
    ...
    methods: {
        ...
        changedForm: function(event) {
            ...
            var formData = {
                'action': 'woodokan_get_form_fields',
                'formProviderId': this.trigger.formProviderId,
                'nonce': adfoin.nonce,
...
jQuery(document).ready(function() {
    ...
    jQuery( '.adfoin-toggle-form input' ).on( 'change', function(e) {
        ...
        var requestData = {
            'action': 'woodokan_enable_integration',
            '_nonce': adfoin.nonce,
